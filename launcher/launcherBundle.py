...
class Launcher(threading.Thread):
	...
	def getBuildsVirsh(self):
		...
		line = f.readline()
		while line:
			if (re.findall("clear-[0-9]*-bundle", line)):

				self._array1.append(re.findall("clear-[0-9]*-bundle", line))
			line = f.readline()
		f.close()
...
print "Starting process launch.py for bundles..."
...
print "Finish process launch.py for bundles"
